...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] primeiraPosition = new int[2];
        int moveNumber;
        ...
        do{
            for(int i = 0; i < A; i++){
                ...
                if(isMovementValid(moveNumber)){
                    board[currentRow+vertical[moveNumber]][currentColum+horizontal[moveNumber]] = movimentoAtual;
                    currentRow+=vertical[moveNumber];
                    currentColum+=horizontal[moveNumber];
                    primeiraPosition[0] = currentRow+=vertical[moveNumber];
                    primeiraPosition[1] = currentColum+=horizontal[moveNumber];
                    movimentoAtual++;
                }
            }
        ...
        if(primeiraPosition[0] == currentRow && primeiraPosition[1]== currentColum){
            System.out.println("!!!!!!!!!!!!!!PASSEIO FECHADO COMPLETO!!!!!!!");
        }
